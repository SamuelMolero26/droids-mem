...
Add this block to your `CLAUDE.md` (global or project). It is the model-judgment
half of the intake gate (ADR-0016): the hooks guarantee *when* to consider
saving; this tells you *whether* and *how* to compose.
